...
export function Component() {
  ...
  const loadSolicitudes = async () => {
    try {
      setLoading(true);
      console.log('🔄 Cargando solicitudes de mantenimiento pendientes...');
      
      // Filtrar por: OriginId = 1 (Mantenimiento) Y RequestStatusId = 1 (Pendiente)
      const response = await getSolicitudesFiltered(
        { 
          tipo: "1",    // 1 = Mantenimiento
  ...
  return (
    <div className="bg-gradient-to-b from-gray-100 to-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-8">
          <p className="text-gray-400 text-sm mb-2">Mantenimiento</p>
          <h1 className="text-4xl font-semibold text-gray-700">
            Gestion de Mantenimiento Urbano
          </h1>
        </div>
              ...
              <ModalHeader className="flex flex-col gap-1 border-b">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                    <Icon name="bi bi-tools" size={24} color="text-blue-600" />
                  </div>
                  <div>
              ...
              <ModalBody className="py-6">
                {selectedSolicitud && (
                  <div className="space-y-6">
                    ...
                    {/* Razón */}
                    <div>
                      <label className="text-sm font-semibold text-gray-600">Razón</label>
              ...
              <ModalBody className="py-6">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Textarea
                      placeholder="Ingrese la razón del rechazo de la solicitud..."
                      value={razonRechazo}
...
Component.displayName = "SolicitudMantenimiento";
